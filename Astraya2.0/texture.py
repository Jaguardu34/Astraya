...
texture_player=[get_sprite(sprite_sheet_player, 0, 320, 11, 354),
                get_sprite(sprite_sheet_player, 15, 320, 31, 354),
                get_sprite(sprite_sheet_player, 32, 320, 46, 354),
                get_sprite(sprite_sheet_player, 47, 320, 64, 354),
                pygame.transform.flip(get_sprite(sprite_sheet_player, 0, 0, 32, 32), True, False),
                pygame.transform.flip(get_sprite(sprite_sheet_player, 15, 320, 31, 354), True, False),
                pygame.transform.flip(get_sprite(sprite_sheet_player, 32, 320, 46, 354), True, False),
                pygame.transform.flip(get_sprite(sprite_sheet_player, 47, 320, 64, 354), True, False)
                ]
